  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div>
          <h4 className="mt-6 text-3xl font-semibold text-blue-500">
            Connect with me
          </h4>
          <p className="text-gray-500 text-xl">
            <br />
            회사와 함께 성장하는 개발자가 되겠습니다. 연락 부탁드립니다.
          </p>
        </div>
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-24">
            ...
            <form>
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:jucham96@gmail.com">Send me email directly</a>
                </div>
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:jucham96@gmail.com">Submit</a>
                </button>
              </div>
            </form>
          </div>
          <div className="w-full flex flex-col md:items-end  mt-12 md:mt-6">
            ...
            >
              https://juchan-story.tistory.com
              <br />
            </a>
